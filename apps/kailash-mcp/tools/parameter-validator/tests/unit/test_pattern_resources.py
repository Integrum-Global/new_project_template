...
def test_search_patterns_by_keyword(validation_tools):
    ...
    with patch.object(validation_tools, '_get_all_pattern_contents', return_value=mock_patterns):
...
def test_get_pattern_by_node_type(validation_tools):
    ...
    with patch.object(validation_tools, 'list_available_patterns', return_value=mock_patterns), \
         patch.object(validation_tools, 'get_pattern_content', side_effect=lambda name: mock_content_map.get(name)):
...
def test_get_error_specific_patterns(validation_tools):
    ...
    mock_patterns = [
        {"name": "parameter-patterns", "filename": "parameter-patterns.md", "category": "troubleshooting"},
        {"name": "connection-patterns", "filename": "connection-patterns.md", "category": "connections"},
        {"name": "cycle-patterns", "filename": "cycle-patterns.md", "category": "cycles"}
    ]
...
def test_get_related_patterns(validation_tools):
    ...
    with patch.object(validation_tools, '_get_all_pattern_contents', return_value=mock_patterns), \
         patch.object(validation_tools, 'get_pattern_content', return_value=base_content):
...
"""
    ...
    with patch.object(validation_tools, 'get_pattern_content', return_value=mock_pattern):
        # Get pattern content
