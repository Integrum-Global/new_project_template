...
'''
    ...
    datetime_errors = [e for e in result["errors"] if "datetime" in e["message"].lower() or "isoformat" in e["message"].lower()]
...
'''
    ...
    json_errors = [e for e in result["errors"] if "json" in e["message"].lower() or "parsing" in e["message"].lower()]
...
'''
    ...
    template_errors = [e for e in result["errors"] if "${" in e["message"] or "template" in e["message"].lower()]
    if len(template_errors) > 0:
        assert "${" in template_errors[0]["message"] or "template" in template_errors[0]["message"].lower()
...
'''
    ...
    type_errors = [e for e in result["errors"] if "type" in e["message"].lower() or "mismatch" in e["message"].lower()]
...
'''
    ...
    none_errors = [e for e in result["errors"] if "none" in e["message"].lower() or "null" in e["message"].lower()]
...
'''
    ...
    boolean_errors = [e for e in result["errors"] if "boolean" in e["message"].lower() or "bool" in e["message"].lower()]
...
'''
    ...
    enum_errors = [e for e in result["errors"] if "enum" in e["message"].lower() or "choice" in e["message"].lower() or "allowed" in e["message"].lower()]
...
'''
    ...
    url_errors = [e for e in result["errors"] if "url" in e["message"].lower() or "invalid" in e["message"].lower()]
...
'''
    ...
    path_errors = [e for e in result["errors"] if "path" in e["message"].lower() or "file" in e["message"].lower()]
...
'''
    ...
    range_errors = [e for e in result["errors"] if "range" in e["message"].lower() or "invalid" in e["message"].lower()]
...
'''
    ...
    coercion_warnings = [e for e in result.get("warnings", []) if "coercion" in e["message"].lower() or "convert" in e["message"].lower()]
