...
class TestDockerInfrastructure:
    ...
    def docker_services(self):
        ...
        compose_file = Path("/Users/esperie/repos/projects/kailash_python_sdk/docker/docker-compose.yml")
    ...
    def test_studio_with_docker_infrastructure(self, docker_services):
        ...
        try:
            ...
            pytest.fail(f"Studio gateway creation with Docker infrastructure failed: {e}")
    ...
    def test_all_infrastructure_ready(self, docker_services):
        ...
        for service_name, (host, port) in services.items():
            try:
                ...
                assert result == 0, f"{service_name} service not available on {host}:{port}"
