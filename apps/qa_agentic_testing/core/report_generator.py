...
class ReportGenerator:
    ...
    async def generate_comprehensive_report_async(self, test_data: Dict[str, Any], 
                                                output_path: Union[str, Path]) -> Path:
        """
    ...
    def _generate_comprehensive_report_sync(self, test_data: Dict[str, Any], 
                                          output_path: Union[str, Path]) -> Path:
    ...
    def _prepare_report_data(self, test_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "test_date" in test_info:
            test_info["test_date_formatted"] = self._format_datetime(test_info["test_date"])
    ...
    def _calculate_overall_score(self, coverage: Dict[str, Any], 
    ...
    def _calculate_performance_diff(self, expected: float, actual: float) -> Dict[str, Any]:
    ...
    def _clean_for_json(self, obj):
        ...
        if hasattr(obj, '__call__'):
            ...
            return {k: self._clean_for_json(v) for k, v in obj.items() if not hasattr(v, '__call__')}
        elif isinstance(obj, (list, tuple)):
            return [self._clean_for_json(item) for item in obj if not hasattr(item, '__call__')]
    ...
    def _generate_html_report(self, report_data: Dict[str, Any]) -> str:
        ...
        def safe_tojson(obj):
            try:
                ...
                if hasattr(obj, '__iter__') and not isinstance(obj, (str, bytes, list, tuple, dict, int, float, bool)):
                    try:
                        obj = list(obj)
...
"""
    ...
    def generate_json_report(self, test_data: Dict[str, Any], 
                           output_path: Union[str, Path]) -> Path:
        """Generate JSON report (sync version for compatibility)."""
        return self._generate_json_report_sync(test_data, output_path)
    
    async def generate_json_report_async(self, test_data: Dict[str, Any], 
                                       output_path: Union[str, Path]) -> Path:
    ...
    def _generate_json_report_sync(self, test_data: Dict[str, Any], 
                                 output_path: Union[str, Path]) -> Path:
