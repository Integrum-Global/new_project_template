...
def test_package_import():
    ...
    try:
        ...
        from apps.qa_agentic_testing import AutonomousQATester, AgentCoordinator
...
def main():
    ...
    if passed == total:
        ...
        print("   1. Direct import: cd apps/qa_agentic_testing && python -c 'from core.test_executor import AutonomousQATester; print(\"Working!\")'")
        print("   2. Package import: python -c 'from apps.qa_agentic_testing import AutonomousQATester; print(\"Working!\")'")
        print("   3. API server: cd apps/qa_agentic_testing && python -c 'from api.main import create_app; app = create_app(); print(\"API ready!\")'")
        print("   4. CLI: cd apps/qa_agentic_testing && python -c 'from cli.main import cli; print(\"CLI ready!\")'")
        print("   5. Example: cd apps/qa_agentic_testing && python examples/simple_test_example.py")
    else:
