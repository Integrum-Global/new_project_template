...
from ...core.models import TestRun, TestType, AgentType, InterfaceType, Priority
...
class CreateRunRequest(BaseModel):
    ...
    interfaces_tested: Optional[List[str]] = Field(None, description="Interfaces to test")
...
async def create_run(
    ...
    try:
        ...
        if request.interfaces_tested:
            kwargs["interfaces_tested"] = [InterfaceType(i) for i in request.interfaces_tested]
