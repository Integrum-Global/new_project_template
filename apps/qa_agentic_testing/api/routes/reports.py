...
async def preview_report(
    ...
    try:
        from ...core.services import TestRunService, TestResultService
        ...
        preview = {
            ...
            "insights_preview": run.ai_insights[:3] if run.ai_insights else [],  # First 3 insights
        ...
        return {
            ...
            "reports": {
                "html": {
                    ...
                    "download_url": f"/api/reports/run/{run_id}/html" if html_exists else None
                },
                "json": {
                    "exists": json_exists,
                    "path": run.json_report_path,
                    "size_bytes": json_size,
                    "download_url": f"/api/reports/run/{run_id}/json" if json_exists else None
                }
            },
...
async def delete_reports(
    ...
    try:
        ...
        await run_service.update_run(run_id, {
