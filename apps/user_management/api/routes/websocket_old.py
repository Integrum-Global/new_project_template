...
from kailash.middleware import WorkflowEvent, EventType, EventStream
...
async def setup_websocket_routes(app):
    ...
    async def admin_websocket(websocket: WebSocket):
        ...
        try:
            ...
            async def handle_auth_events(event: WorkflowEvent):
                ...
                if event.type in [EventType.USER_AUTHENTICATED, EventType.USER_LOGGED_OUT]:
                    await websocket.send_json({
                        "type": "auth_event",
                        "event": event.type.value,
                        "data": event.data,
            ...
            await realtime.event_stream.subscribe("security_events", handle_security_events)
    ...
    async def user_websocket(
        ...
        try:
            ...
            await realtime.event_stream.subscribe(f"user_{user_id}", handle_personal_events)
