...
class UserLifecycleWorkflowRefactored:
    ...
    def __init__(self, admin_user_id: str = "admin", api_base_url: str = "http://localhost:8000"):
        """
    ...
    def create_single_user(self, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        builder.add_node("HTTPRequestNode", "create_user_api", {
        ...
        builder.add_node("DataTransformer", "prepare_role_data", {
        ...
        builder.add_node("HTTPRequestNode", "assign_role_api", {
        ...
        builder.add_node("AuditLogNode", "audit_user_creation", {
        ...
        builder.add_connection("validate_user_input", "result", "create_user_api", "validation_result")
        builder.add_connection("create_user_api", "result.data", "prepare_role_data", "user_data")
        builder.add_connection("prepare_role_data", "result", "assign_role_api", "role_data")
        builder.add_connection("create_user_api", "result.data", "audit_user_creation", "user_info")
    ...
    def bulk_create_users(self, users_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        builder.add_node("PythonCodeNode", "validate_bulk_data", {
...
"""
        ...
        builder.add_node("HTTPRequestNode", "bulk_create_api", {
        ...
        builder.add_node("DataTransformer", "process_bulk_results", {
        ...
        builder.add_node("AuditLogNode", "audit_bulk_creation", {
        ...
        # Connect nodes
        builder.add_connection("validate_bulk_data", "result.result", "bulk_create_api", "bulk_data")
        builder.add_connection("bulk_create_api", "result.data", "process_bulk_results", "api_results")
        builder.add_connection("process_bulk_results", "result", "audit_bulk_creation", "bulk_stats")
    ...
    def deactivate_user(self, user_id: str, reason: str = "standard_deactivation") -> Dict[str, Any]:
        ...
        builder.add_node("HTTPRequestNode", "get_user_details", {
        ...
        builder.add_node("HTTPRequestNode", "deactivate_user_api", {
        ...
        builder.add_node("HTTPRequestNode", "gdpr_compliance_check", {
        ...
        builder.add_node("AuditLogNode", "audit_deactivation", {
        ...
        # Connect nodes
        builder.add_connection("get_user_details", "result.data", "deactivate_user_api", "user_info")
        builder.add_connection("deactivate_user_api", "result.data", "gdpr_compliance_check", "deactivation_result")
        builder.add_connection("gdpr_compliance_check", "result.data", "audit_deactivation", "compliance_result")
    ...
    def export_user_data(self, user_id: str, export_format: str = "json") -> Dict[str, Any]:
        ...
        builder.add_node("HTTPRequestNode", "request_data_export", {
        ...
        # Check export status
        builder.add_node("SwitchNode", "check_export_status", {
        ...
        builder.add_node("DataTransformer", "package_export", {
        ...
        # Connect nodes
        builder.add_connection("request_data_export", "result.data", "check_export_status", "export_result")
        builder.add_connection("check_export_status", "completed", "package_export", "export_data")
        builder.add_connection("package_export", "result", "audit_export", "packaged_data")
    ...
    def run_comprehensive_user_lifecycle_demo(self) -> Dict[str, Any]:
        ...
        try:
            ...
            user_id = demo_results.get("single_user", {}).get("create_user_api", {}).get("result", {}).get("data", {}).get("id", "user123")
            demo_results["data_export"] = self.export_user_data(user_id, "json")
            
            # 4. Deactivate user
            print("\n4. Deactivating User...")
            demo_results["user_deactivation"] = self.deactivate_user(user_id, "demonstration_complete")
    ...
    def print_lifecycle_summary(self, results: Dict[str, Any]):
        ...
        if "data_export" in results and "request_data_export" in results["data_export"]:
            export_result = results["data_export"]["request_data_export"].get("result", {})
        ...
        if "user_deactivation" in results and "deactivate_user_api" in results["user_deactivation"]:
            deactivate_result = results["user_deactivation"]["deactivate_user_api"].get("result", {})
