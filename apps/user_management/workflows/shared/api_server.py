...
ProfileSetupWorkflow = load_workflow_class(
    "../user_workflows/scripts/01_profile_setup.py", "ProfileSetupWorkflow"
)
SecuritySettingsWorkflow = load_workflow_class(
    "../user_workflows/scripts/02_security_settings.py", "SecuritySettingsWorkflow"
)
DataManagementWorkflow = load_workflow_class(
    "../user_workflows/scripts/03_data_management.py", "DataManagementWorkflow"
)
PrivacyControlsWorkflow = load_workflow_class(
    "../user_workflows/scripts/04_privacy_controls.py", "PrivacyControlsWorkflow"
)
SupportRequestsWorkflow = load_workflow_class(
    "../user_workflows/scripts/05_support_requests.py", "SupportRequestsWorkflow"
)

TeamSetupWorkflow = load_workflow_class(
    "../manager_workflows/scripts/01_team_setup.py", "TeamSetupWorkflow"
)
UserManagementWorkflow = load_workflow_class(
    "../manager_workflows/scripts/02_user_management.py", "UserManagementWorkflow"
)
PermissionAssignmentWorkflow = load_workflow_class(
    "../manager_workflows/scripts/03_permission_assignment.py",
    "PermissionAssignmentWorkflow",
)
ReportingAnalyticsWorkflow = load_workflow_class(
    "../manager_workflows/scripts/04_reporting_analytics.py",
    "ReportingAnalyticsWorkflow",
)
ApprovalWorkflow = load_workflow_class(
    "../manager_workflows/scripts/05_approval_workflows.py", "ApprovalWorkflow"
)

SystemSetupWorkflow = load_workflow_class(
    "../admin_workflows/scripts/01_system_setup.py", "SystemSetupWorkflow"
)
UserLifecycleWorkflow = load_workflow_class(
    "../admin_workflows/scripts/02_user_lifecycle.py", "UserLifecycleWorkflow"
)
SecurityManagementWorkflow = load_workflow_class(
    "../admin_workflows/scripts/03_security_management.py", "SecurityManagementWorkflow"
)
MonitoringAnalyticsWorkflow = load_workflow_class(
    "../admin_workflows/scripts/04_monitoring_analytics.py",
    "MonitoringAnalyticsWorkflow",
)
BackupRecoveryWorkflow = load_workflow_class(
    "../admin_workflows/scripts/05_backup_recovery.py", "BackupRecoveryWorkflow"
)
...
db_manager = MiddlewareDatabaseManager(
    database_url=os.getenv("DATABASE_URL", "sqlite+aiosqlite:///user_management.db")
)
...
async def request_access(
    request: AccessRequest, user: UserContext = Depends(get_current_user)
):
...
async def setup_mfa(
    request: MFASetupRequest, user: UserContext = Depends(get_current_user)
):
...
async def update_privacy_settings(
    request: PrivacySettingsRequest, user: UserContext = Depends(get_current_user)
):
...
async def create_support_ticket(
    request: SupportTicketRequest, user: UserContext = Depends(get_current_user)
):
...
@app.post(
    ...
    response_model=WorkflowResponse,
    tags=["Manager Workflows"],
)
async def setup_team(
    request: TeamSetupRequest, user: UserContext = Depends(require_user_type("manager"))
):
    """Setup new team"""
    try:
...
@app.post(
    "/api/v1/manager/permissions/update",
    response_model=WorkflowResponse,
    tags=["Manager Workflows"],
)
...
async def generate_report(
    request: ReportRequest, user: UserContext = Depends(require_user_type("manager"))
):
    """Generate reports"""
    try:
...
@app.post(
    "/api/v1/manager/approvals/process",
    response_model=WorkflowResponse,
    tags=["Manager Workflows"],
)
...
async def create_backup(
    ...
    try:
        ...
        background_tasks.add_task(workflow.manage_backup_operations, backup_config)
