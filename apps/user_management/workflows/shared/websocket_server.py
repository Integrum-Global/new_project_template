...
class ConnectionManager:
    ...
    async def connect(
        self, websocket: WebSocket, user_id: str, session_data: Dict[str, Any]
    ):
    ...
    async def broadcast_to_channel(
        self, channel: str, message: Dict[str, Any], exclude_user: Optional[str] = None
    ):
...
async def handle_websocket_message(
    user_id: str, message: Dict[str, Any], session_data: Dict[str, Any]
):
...
def build_approval_notification(
    request_id: str, requester: str, resource: str
) -> Dict[str, Any]:
...
def build_security_alert(
    alert_type: str, details: str, severity: str = "medium"
) -> Dict[str, Any]:
