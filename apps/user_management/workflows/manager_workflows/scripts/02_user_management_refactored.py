...
class ManagerUserManagementWorkflowRefactored:
    ...
    def __init__(
        self, manager_id: str = "manager", api_base_url: str = "http://localhost:8000"
    ):
        """
    ...
    def add_team_member(self, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        builder.add_node(
            "RoleServiceNode", "check_permissions", {"operation": "check_permission"}
        )

        # Create user through UserService
        builder.add_node("UserServiceNode", "create_user", {"operation": "create_user"})
        ...
        builder.add_node(
            "RoleServiceNode", "setup_permissions", {"operation": "assign_role"}
        )
        ...
        builder.add_node(
            ...
            "audit_addition",
            {
                ...
                "details": {"team": "manager_team", "role": "team_member"},
            },
        )

        # Connect workflow nodes
        builder.add_connection(
            "check_permissions", "has_permission", "create_user", "permission_check"
        )
        builder.add_connection("create_user", "user", "assign_to_team", "user_data")
        builder.add_connection(
            "assign_to_team", "result.data", "setup_permissions", "team_assignment"
        )
        builder.add_connection(
            "setup_permissions", "result", "send_welcome", "permission_result"
        )
        builder.add_connection(
            "send_welcome", "result", "audit_addition", "notification_result"
        )
    ...
    def update_member_profile(
        ...
        builder.add_node("UserServiceNode", "update_user", {"operation": "update_user"})
        ...
        builder.add_node(
            ...
            "check_role_update",
            {
                ...
                "cases": {"true": "update_role", "false": "skip_role_update"},
                "default_case": "skip_role_update",
            },
        )

        # Update role if needed
        builder.add_node("RoleServiceNode", "update_role", {"operation": "assign_role"})
        ...
        # Connect workflow nodes
        builder.add_connection(
            "verify_authority", "result.data", "update_user", "authority_check"
        )
        builder.add_connection(
            "update_user", "user", "check_role_update", "update_result"
        )
        builder.add_connection("check_role_update", "true", "update_role", "role_data")
        builder.add_connection(
            "check_role_update", "false", "audit_update", "final_result"
        )
        builder.add_connection(
            "update_role", "result", "audit_update", "role_update_result"
        )
    ...
    def list_team_members(self, filters: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        builder.add_node(
            ...
            "apply_filters",
            {
                ...
                "operations": [
                    {"type": "filter", "config": {"conditions": filters or {}}},
                    {"type": "sort", "config": {"by": "last_name", "order": "asc"}},
                ],
            },
        )
        ...
        # Connect workflow nodes
        builder.add_connection(
            "get_team_members", "result.data", "apply_filters", "members"
        )
        builder.add_connection(
            "apply_filters", "result", "enrich_roles", "filtered_members"
        )
    ...
    def run_demo(self) -> Dict[str, Any]:
        ...
        try:
            ...
            updates = {"position": "Developer", "phone": "+1-555-0123"}
...
def test_workflow(test_params: Optional[Dict[str, Any]] = None) -> bool:
    ...
    try:
        ...
        builder.add_node(
            "UserServiceNode", "test_user_service", {"operation": "list_users"}
        )

        builder.add_node(
            "RoleServiceNode", "test_role_service", {"operation": "check_permission"}
        )
