...
class TestUserManagementAPI:
        ...
        return {
            ...
            "auth_provider": EnterpriseAuthProviderNode(
                ...
                sso_config={
                    ...
                    "saml_settings": {"entity_id": "https://sso.company.com"},
                },
                directory_config={
                    "directory_type": "ldap",
                    "connection_config": {"server": "ldap://dc.company.com"},
                },
            ),
            "permission_eval": ABACPermissionEvaluatorNode(
                name="permission_evaluator", ai_reasoning=True
            ),
        }
    ...
    def test_user_creation_workflow(self, app_components, test_users):
        ...
        for user_data in test_users:
            result = runtime.execute(
                workflow,
                inputs={
                    "user_management": {"action": "create", "user_data": user_data}
                },
            )
            ...
            assert (
                result.outputs["role_management"]["roles_assigned"]
                == user_data["roles"]
            )
    ...
    def test_authentication_flow(self, app_components):
        ...
        with patch.object(
            app_components["auth_provider"], "_authenticate_with_provider"
        ) as mock_auth:
    ...
    def test_user_update_with_audit(self, app_components):
        ...
        admin_context = {"user_id": "admin", "roles": ["admin"], "department": "IT"}
        ...
        result = runtime.execute(
            ...
            inputs={
                ...
                "user_management": {
                    "action": "update",
                    "user_id": "jdoe",
                    "updates": {"department": "DevOps", "title": "Senior Engineer"},
                    "updated_by": "admin",
                },
            },
        )
            ...
            inputs={
                ...
                "user_management": {
                    ...
                    "profile_updates": {
                        ...
                        "preferences": {"notifications": "email", "theme": "dark"},
                    },
                },
            },
        )
    ...
    def test_integration_with_external_systems(self, app_components):
        ...
        with patch.object(
            app_components["auth_provider"], "_sync_from_ldap"
        ) as mock_sync:
