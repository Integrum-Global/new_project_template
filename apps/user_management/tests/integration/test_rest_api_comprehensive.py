...
async def auth_headers(test_user):
    ...
    builder.add_node("PythonCodeNode", "generate_token", {
...
"""
    ...
    token = results.get("generate_token", {}).get("result", {}).get("token", "test_token")
...
class TestUserEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_update_user(self, async_client: AsyncClient, test_user, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_list_users_with_filters(self, async_client: AsyncClient, auth_headers):
...
class TestPermissionEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_check_permission(self, async_client: AsyncClient, test_user, auth_headers):
...
class TestRoleEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_assign_role(self, async_client: AsyncClient, test_user, auth_headers):
...
class TestSSOEndpoints:
    ...
    async def test_sso_login_flow(self, async_client: AsyncClient):
        ...
        response = await async_client.get("/api/sso/login/google?redirect_uri=http://localhost:3000/callback")
        assert response.status_code == 200
...
class TestComplianceEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_data_export(self, async_client: AsyncClient, test_user, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_consent_management(self, async_client: AsyncClient, test_user, auth_headers):
...
class TestAdminEndpoints:
    ...
    async def test_user_statistics(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.get("/api/admin/statistics/users", headers=auth_headers)
        assert response.status_code == 200
    ...
    async def test_security_metrics(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.get("/api/admin/statistics/security", headers=auth_headers)
        assert response.status_code == 200
    ...
    async def test_performance_metrics(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.get("/api/admin/statistics/performance", headers=auth_headers)
        assert response.status_code == 200
    ...
    async def test_export_dashboard(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.get(
            "/api/admin/export/dashboard?format=json",
            headers=auth_headers
        )
        assert response.status_code == 200
...
class TestWorkflowIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complete_user_lifecycle(self, async_client: AsyncClient, auth_headers):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_permission_denied(self, async_client: AsyncClient, test_user, auth_headers):
